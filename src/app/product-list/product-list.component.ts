...
export class ProductListComponent {
 //name = "snehal"
 listOfString: string[] = ["mark", "joe", "john"];
 addToCart: number =0;
  product = {
    name: 'iPhone X',
    price: 789,
  ...
  onNameChange(event : any) {
    // this.name= event.target.value;    // when name input is mark this event will get triggered
  }
  decrementCartValue(){
    if (this.addToCart > 0){
      this.addToCart--;
  ...
  incrementCartValue(){  //one way data binding
